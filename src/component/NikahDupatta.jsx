...
import NikahDupattaCarousel from "./NikahDupattaCarousel";

const ADMIN_PHONE =
  import.meta.env.VITE_ADMIN_PHONE || "919801259190";

const NIKAH_DUPATTA = {
  title: "प्रीमियम निकाह दुपट्टा",
  priceRange:"600 – ₹900",
  Materials: "Premium Net. And Qubul Hai dupatta With Customize Name",
};
...
export default function NikahDupatta() {
  const [showNamaQuestion, setShowNamaQuestion] = useState(false);
  const [wantsNikahNama, setWantsNikahNama] = useState(false);
  ...
  const handleWhatsAppOrder = (e) => {
    ...
    const namaText = wantsNikahNama
      ? `Yes - ${NIKAH_NAMA.title}`
      : "No - Customer does not want Nikah Nama";
...
🧕 Design: ${NIKAH_DUPATTA.title}
💰 Price: ₹${NIKAH_DUPATTA.priceRange}
...
Please confirm my Nikah Dupatta order. 🙏
`;
      ...
      <div className="relative z-10">
        ...
        <div className="text-center px-4 mb-8">
          ...
          <p className="mt-3 text-blue-100 text-sm sm:text-base">
            खूबसूरत और प्रीमियम निकाह दुपट्टा
          </p>
              ...
              <div className="flex items-center justify-between mt-5">
                ...
                <div>
                  ...
                  <span className="text-2xl font-extrabold text-pink-600">
                    ₹{NIKAH_DUPATTA.priceRange}
                  </span>
                  {/* <span className="text-2xl font-extrabold text-pink-600">
                    ₹{NIKAH_DUPATTA.Materials}
                  </span> */}
                  <p className="text-sm text-slate-600 mt-2">
                📄 {NIKAH_DUPATTA.Materials}
              </p>
                ...
                <button
                  type="button"
                  onClick={() => setShowNamaQuestion(true)}
          ...
          <div className="relative w-full max-w-md bg-white rounded-2xl shadow-2xl overflow-hidden">
            ...
            <div className="p-6 text-center">
              ...
              <div className="w-20 h-20 mx-auto mb-4 rounded-xl overflow-hidden bg-gray-100">
                <img
                  src="/images/nikah-nama/nikah-nama-2.webp"
                  alt="Nikah Dupatta"
              ...
              <h3 className="text-xl font-bold text-slate-800">
                क्या आप निकाह दुपट्टा के साथ निकाह नामा भी खरीदना चाहते हैं?
              </h3>

              <p className="text-sm text-slate-500 mt-2">
                निकाह दुपट्टा के साथ निकाह नामा भी उपलब्ध है।
              </p>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mt-6">
                ...
                <button
                  type="button"
                  onClick={() => {
                    setWantsNikahNama(true);
                    setShowNamaQuestion(false);
                    setShowForm(true);
                  }}
              ...
              <button
                type="button"
                onClick={() => setShowNamaQuestion(false)}
